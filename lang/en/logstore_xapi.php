...
$string['actor'] = 'Actor Settings';
$string['actor_help'] = 'Settings pertaining to the xAPI Actor field.';
$string['actor_identification_type'] = 'Field to use to identify users';
$string['actor_identification_type_desc'] = 'Statements will identify users account name with this selection, but only if identifying users by email is disabled.';
$string['oauth2'] = 'Identify users homepage via OAuth2 issuer';
$string['oauth2_desc'] = 'Statements will identify users homepage with their OAuth2 Issuer base URL when this box is ticked, but only if identifying users by email is disabled and the user logged in via OAuth2.';
...
$string['coursecategory'] = 'Send course category';
$string['coursecategory_desc'] = 'Statements will contain the category for a course as a course category extension.';
$string['sendidnumber'] = 'Send course and activity ID number';
$string['sendidnumber_desc'] = 'Statements will include the ID number (admin defined) for courses and activities in the object extension.s';
